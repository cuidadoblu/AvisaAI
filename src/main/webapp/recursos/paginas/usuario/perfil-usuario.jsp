            ...
            <c:when test="${usuarioLogado != null}">
                <div class="perfil-container">
                    <div class="perfil-imagem">
                        <img src="${usuarioLogado.fotoPerfil}" alt="Foto de ${usuarioLogado.nome} ${usuarioLogado.sobrenome}">
                    ...
                    <div class="perfil-botoes">
                        <button type="button" onclick="window.location.href='incidentes-acompanhados'">
                            ...
                            <span>Incidentes Acompanhados</span>
                        </button>
                        ...
                        <a href="logout" class="perfil-logout">
                            <img src="img/icone-logout.png" alt="Logout">
                            Sair
                        </a>
                    </div>
                </div>
