...
<link rel="stylesheet" type="text/css"
	href="../../css/incidente/incidente.css">
<link rel="shortcut icon" href="img" type="image/x-icon">

</head>
<body class="cadastro-incidente">
	<main>
				...
				<div class="formulario-entradas">
					...
					<div class="formulario-grupo">
						<label for="usuario">Usuário</label> <input type="text"
							id="usuario" name="id-usuario" class="formulario-controle"
							placeholder="Insira o id do autor" maxlength="50" required>
					</div>

					<div class="formulario-grupo">
						<label for="logradouro">Logradouro</label> <select id="logradouro"
							name="id-localidade" class="formulario-controle" required>
					...
					<div class="formulario-grupo">
						<label for="comunidade">Comunidade</label> <select id="comunidade"
							name="id-comunidade" class="formulario-controle" required>
	...
	<script
		src="<%=request.getContextPath()%>/recursos/js/incidente/incidente.js"></script>
</body>
</html>